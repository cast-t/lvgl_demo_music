...
static lv_style_t style_scrollbar;  //右侧进度条
static lv_style_t style_btn;
static lv_style_t style_btn_pr; //按下时按键样式
static lv_style_t style_btn_chk;    //选中时按键样式
static lv_style_t style_btn_dis;    //禁止时按键样式
...
//列表中的按键采用弹性布局，按键中的内容（播放图标、歌名、作曲家、时间）采用网格布局
...
lv_obj_t * _lv_demo_music_list_create(lv_obj_t * parent)
{
    ...
    //三种状态三个风格，用于强调按键是否被选中
    //style of button in pressed state
    ...
    //style of button in checked state
    ...
    //style of button in disabled state
